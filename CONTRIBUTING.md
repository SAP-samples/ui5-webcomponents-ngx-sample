# Contributing to UI5 Webcomponents for Angular Sample Application
...
Go to [the Github issue tracker](https://github.com/SAP-samples/ui5-webcomponents-ngx-sample/issues) and find an open issue which needs additional work or a bugfix.
...
You can go to the [Github issue tracker](https://github.com/SAP-samples/ui5-webcomponents-ngx-sample/issues/new) to report the issue.
...
1. **Only real bugs**: please do your best to make sure to only report real bugs! Do not report:
   * issues caused by application code or any code outside UI5 Webcomponents for Angular Sample Application.
   * issues caused by the usage of non-public UI5 Webcomponents for Angular Sample Application methods.
...
An issue that is about a real bug is closed as soon as the fix is committed. The closing comment explains which patch version(s) of UI5 Webcomponents for Angular Sample Application will contain the fix.
...
We want to improve the quality of UI5 Webcomponents for Angular and UI5 Webcomponents for Angular Sample Application, and good bug reports are welcome! But our capacity is limited, so we cannot handle questions or consultation requests and we cannot afford to ask for required details. So we reserve the right to close or to not process insufficient bug reports in favor of those which are very cleanly documented and easy to reproduce. Even though we would like to solve each well-documented issue, there is always the chance that it won't happen - remember: UI5 Webcomponents for Angular and UI5 Webcomponents for Angular Sample Application are Open Source and come without warranty.
...
You are welcome to contribute code to UI5 Webcomponents for Angular Sample Application in order to fix bugs or to implement new features.
...
3.  **Not all proposed contributions can be accepted**. Some features may e.g. just fit a third-party add-on better. The code must fit the overall direction of UI5 Webcomponents for Angular and really improve it, so there should be some "bang for the byte".
...
1. is useful to improve UI5 Webcomponents for Angular Sample Application (explained above)
...
-   [use "jQuery" instead of "$"](http://learn.jquery.com/using-jquery-core/avoid-conflicts-other-libraries/)
...
-   Always consider the developer who USES your control/code!
    ...
    -   Think about what they expects your control/feature to do

### How to contribute - the Process

1.  Make sure the change would be welcome (e.g. a bugfix or a useful feature); best do so by proposing it in a GitHub issue
2.  Create a branch forking the UI5 Webcomponents for Angular Sample Application repository and do your change
...
4.  In the commit message follow the [commit message guidelines](https://github.com/SAP/openui5/blob/master/docs/guidelines.md)
5.  If your change fixes an issue reported at GitHub, add the following line to the commit message:
    - ```Fixes https://github.com/SAP-samples/ui5-webcomponents-ngx-sample/issues/(issueNumber)```
6.  Create a Pull Request to ```https://github.com/SAP-samples/ui5-webcomponents-ngx-sample```
...
8.  Wait for our code review and approval, possibly enhancing your change on request
    -   Note that the UI5 Webcomponents for Angular developers also have their regular duties, so depending on the required effort for reviewing, testing and clarification this may take a while
