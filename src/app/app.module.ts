      ...
      bundle: {
        ...
        translations: {
          useFactory: () => {
            ...
            return {
              en: http.get("assets/i18n/messages_en.json", {
                responseType: "json",
              }),
              zh_TW: http.get("assets/i18n/messages_zh_TW.json", {
                responseType: "json",
              }),
              bg: http.get("assets/i18n/messages_bg.json", {
                responseType: "json",
              }),
              ar: http.get("assets/i18n/messages_ar.json", {
                responseType: "json",
              }),
            };
          },
