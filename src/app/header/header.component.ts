...
export class HeaderComponent {
  ...
  ngOnInit() {
    zip([
      this.appService.getDomesticTrips(),
      this.appService.getInternationalTrips(),
  ...
  shellbarMenuClicked() {
    var element = document.getElementById(
      "shellbar"
    ) as unknown as ShellBarComponent;
    if (element && (element as any).closeOverflow)
      (element as any).closeOverflow();
  }
}
